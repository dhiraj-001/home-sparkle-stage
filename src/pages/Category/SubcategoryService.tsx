    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        ...
        <ServicesStickyNavbar
          ...
          filteredServicesCount={filteredAndSortedServices.length}
          isLoading={loading}
        />
