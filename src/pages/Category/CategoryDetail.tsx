...
import { ChevronRight, Home, Search, Grid3x3, TrendingUp, ArrowRight, Star } from "lucide-react"
...
const CategoryChildList: React.FC = () => {
  ...
  const totalServices = categories.reduce((sum, cat) => sum + cat.services_count, 0)
          ...
          <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 text-white py-20">
            <div className="container mx-auto px-4">
              ...
              <div className="flex gap-8 mt-8">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="h-20 bg-white/20 rounded-lg w-48 animate-pulse"></div>
                ))}
              </div>
            </div>
          </div>
        ...
        <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 text-white overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 py-16">
            <nav className="flex items-center space-x-2 text-sm mb-6">
              <Link to="/" className="hover:text-white/80 transition-colors flex items-center">
            ...
            <div className="max-w-4xl">
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-balance">Explore Sub Categories</h1>
              <p className="text-lg text-white/90 mb-8 text-pretty">
                Discover our comprehensive range of specialized services tailored to meet your needs
              </p>
            </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold">{categories.filter((c) => c.is_featured === 1).length}</p>
                  </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto text-lg text-pretty">
                Select a category to explore our specialized services and find exactly what you need
              </p>
            </div>
                  ...
                  {filteredCategories.map((category) => (
                    ...
                    >
                      ...
                      <div className="relative h-64 overflow-hidden">
                        ...
                        {/* Gradient Overlay */}
                        <div
                          className={`absolute inset-0 bg-gradient-to-t ${getGradientByCategory(category)} opacity-60`}
                        />
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
                          <h3 className="text-2xl font-bold text-white mb-1 line-clamp-2">{category.name}</h3>
                        </div>
                      </div>
                        ...
                        <div className="flex items-center justify-between mb-6 pb-6 border-b border-gray-100">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-semibold text-gray-900">{category.services_count}</p>
                            </div>
                          </div>
